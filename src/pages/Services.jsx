...
const SERVICES = [
  {
    ...
    desc: 'Imagine Pharma Research Training helps students and professionals build careers in pharmaceutical research. Our comprehensive programs teach practical and theoretical skills across drug discovery, chemical synthesis, regulatory affairs, and quality management.',
    features: [
      'Drug discovery & development pathways',
      'Chemical synthesis fundamentals & advanced topics',
      'Software training: Chemdraw, ISIS Draw, Scifinder, Reaxys',
      'Regulatory affairs & compliance (ICH, USFDA, EU, CDSCO)',
